...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
            ...
            <!-- Container fluid  -->
            <!-- ============================================================== -->
			<div class="container-fluid" style="margin: 15px 30%">
			<h3 class="ml-3" >Thêm sản phẩm</h3>
			<div class="ml-3" style="font-size: 16px; font-weight:500;color:#28a745"> ${message}</div> 
			<form:form action="admin/products/add.htm" method="Post" modelAttribute="product">
				...
				<div class="form-group col-md-4">
					...
					<form:input type="text"
						class="form-control" path="name" placeholder="Nhập tên sản phẩm"/>
				</div>
				<div class="form-group col-md-4">
					<label for="price">Giá:</label> 
					<form:errors path="price" />
					<form:input type="text"
						class="form-control" path="price" placeholder="Nhập giá sản phẩm"/>
				</div>
				<div class="form-group col-md-4">
					<label for="discount">Discount:</label> 
					<form:errors path="discount" />
					<form:input type="text"
						class="form-control" path="discount" placeholder="Giảm giá"/>
				</div>
				...
				<div class="form-group col-md-4">
					...
					<form:input type="text"
						class="form-control" path="quantity" placeholder="Nhập số lượng"/>
				</div>
				<div class="form-group col-md-4">
					...
					<form:select path="category.id" items="${categories}"
						...
						class=" form-select form-control form-select-lg" aria-label=".form-select-lg example">
					</form:select>
				</div>
				<div class="form-group col-md-4">
					...
					<form:textarea type="text"
						class="form-control" path="description" placeholder="Mô tả"/>
				</div>
				<c:choose>
					<c:when test="${btnStatus=='btnEdit' }">
							<button type="submit" name="btnEdit" class="btn btn-success ml-3">Lưu sản phẩm</button>							
					</c:when>
					<c:otherwise>
						<button type="submit" name="btnAdd" class="btn btn-success ml-3">Thêm sản phẩm</button>						
					</c:otherwise>
				</c:choose>			
