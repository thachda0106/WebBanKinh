            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Admin Products</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item" style="display: flex; align-items: center;"><a href="#">Home</a>
                                    <span style= "color: #99abb4; font-size: 16px;" ><i class ="mdi mdi-chevron-right"></i> Products </span>
									...
									<table class="table user-table" style="text-align: center" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0"  colspan="3">Actions</th>                                                                                        
                                            </tr>
                                        </thead>
                                        <tbody>
