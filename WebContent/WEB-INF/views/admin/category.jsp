  			   ...
  			   <form:input type="text" id="fname" path="name" placeholder = "Name" class = "mr-2" />
	  			   <c:choose>
	  			   		<c:when test="${btnStatus=='btnAdd'}">
	  			   			<button name="${btnStatus}"  type="submit" class="btn btn-success mr-3 mb-2"> Thêm</button>
	  			   		</c:when>
	  			    	<c:otherwise>
	  	 			    	<button name="${btnStatus}"  type="submit" class="btn btn-success mr-3 mb-2"> Lưu</button>
	  			    	</c:otherwise>
	  			   </c:choose>
			...
			<c:url value="admin/category/index.htm" var="pagedLink">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">	
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="color: #1e88e5;">Danh mục sản phẩm</h4>
									...
									<table class="table user-table" style="text-align: center" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>   
                                                ...
                                                <td>${p.name}</td>                                  
												<td>
												<a href="admin/category/${p.id}.htm?linkEdit"> <button type="button" class="btn btn-info mr-3"> <i class="fas fa-edit" style="font-size:16px;"></i> Sửa </button> </a>	
											    <button type="button" onclick="Check('admin/category/${p.id}.htm?linkDelete')" class="btn btn-danger ml-3 mr-3""> <i class="fas fa-trash-alt" style="font-size:16px;"></i> xóa </button>
												</td>    											
                                            </tr>
                                        	</c:forEach>
